		...
		<div class="card-sm-10">
			<div class="card-body">
				<form class="form-sign" action="ValidateUser" method="POST">
				 	...
				 	<div class="form-group">
				 	<label>Senha:</label>
				 		    <input type="password" min="8" max="100" name="pass" id="myInput" class="form-control" >
	                        <input class="pt-2" type="checkbox" onclick="myFunction()">Show Password
				 	</div>
				 	
				  <div class="mt-3">
			 	  <input type="submit" name="menu" value="Registrar" class="btn btn-primary">
